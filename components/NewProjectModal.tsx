// ============================================================
// NewProjectModal.tsx — versão final e corrigida
// ============================================================
...
interface NewProjectModalProps {
  onClose: () => void;
  onSubmit: (data: { title: string; address: string; details: ProjectDetails }) => void;
}
...
export const NewProjectModal: React.FC<NewProjectModalProps> = ({
  ...
  const [details, setDetails] = useState<ProjectDetails>({
    ...
    size: 0,
    description: "",
    area: 0, // permitido pela interface ProjectDetails
  });
