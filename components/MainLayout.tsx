...
import { Home, Settings, Camera, LogOut, Menu } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen-safe w-full bg-brand-gray-50 dark:bg-black text-gray-900 dark:text-white overflow-hidden font-sans transition-colors duration-300">
      ...
      <aside className="hidden md:flex flex-col w-64 bg-white dark:bg-[#121212] border-r border-gray-200 dark:border-white/5 h-full shrink-0 z-30 transition-colors duration-300">
        ...
        {/* LOGO DA MARCA (Substituindo o ícone S) */}
        <div className="p-8 flex items-center justify-center">
          {/* Logo Colorido (Modo Claro) */}
          <img 
            src="/brand/logo_color.png" 
            alt="Snap Immobile" 
            className="h-12 w-auto object-contain dark:hidden" 
          />
          {/* Logo Branco (Modo Escuro) */}
          <img 
            src="/brand/logo_color.png" 
            alt="Snap Immobile" 
      ...
      <div className="flex-1 flex flex-col h-full relative w-full overflow-hidden">
        ...
        {/* === BOTTOM BAR (Mobile) === */}
        <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-[#121212] border-t border-gray-200 dark:border-white/5 pb-[env(safe-area-inset-bottom)] z-50 transition-colors duration-300 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
