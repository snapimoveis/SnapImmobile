...
function App() {
  ...
  const handleRegistrationSubmit = async (data: any) => {
    try {
      ...
      const newUser = await registerUser(newProfile, data.password);
      ...
      case AppRoute.MENU:
        return (
          <ManagementMenu
            ...
            onNavigate={(r) => r === "SETTINGS" ? setCurrentRoute(AppRoute.SETTINGS) : setCurrentRoute(AppRoute.DASHBOARD)}
